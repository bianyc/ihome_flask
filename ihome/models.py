...
house_facility = db.Table(
    "ih_house_facility",
    db.Column("house_id", db.Integer, db.ForeignKey("ih_house_info.house_id"), primary_key=True),
    db.Column("fac_id", db.Integer, db.ForeignKey("ih_facility_info.fac_id"), primary_key=True)
)
...
class House(BaseModel, db.Model):
    ...
    user_id = db.Column(db.Integer, db.ForeignKey("ih_user_profile.user_id"), nullable=False)  # 房屋主人的用户编号
    area_id = db.Column(db.Integer, db.ForeignKey("ih_area_info.area_id"), nullable=False)  # 归属地的区域编号
...
class Facility(BaseModel, db.Model):
    ...
    fac_id = db.Column(db.Integer, primary_key=True)  # 设施编号
...
class HouseImage(BaseModel, db.Model):
    ...
    img_id = db.Column(db.Integer, primary_key=True)  # 图片编号
    house_id = db.Column(db.Integer, db.ForeignKey("ih_house_info.house_id"), nullable=False)  # 房屋编号
...
class Order(BaseModel, db.Model):
    ...
    order_id = db.Column(db.Integer, primary_key=True)  # 订单编号
    user_id = db.Column(db.Integer, db.ForeignKey("ih_user_profile.user_id"), nullable=False)  # 下订单的用户编号
    house_id = db.Column(db.Integer, db.ForeignKey("ih_house_info.house_id"), nullable=False)  # 预订的房间编号
    ...
    status = db.Column(
        ...
        default="WAIT_ACCEPT", index=True)  # 订单的状态
